...
- [x] **RES-01**: 用户可以预览生成的图片（在线展示）
- [x] **RES-02**: 用户可以预览生成的视频（在线播放）
- [x] **RES-03**: 用户可以将生成的图片/视频下载到本地
- [x] **RES-04**: 用户可以分享生成结果的链接

### History（历史记录）

- [x] **HIST-01**: 用户可以查看历史生成记录列表（本地持久化）
- [x] **HIST-02**: 用户可以从历史记录中复用提示词重新发起任务
- [x] **HIST-03**: 用户可以收藏历史记录中的结果
- [x] **HIST-04**: 用户可以删除历史记录

### Prompt UX（提示词体验）

- [x] **PROMPT-01**: 用户可以从内置提示词模板库选择模板
- [x] **PROMPT-02**: 用户可以自由输入提示词
- [x] **PROMPT-03**: 用户可以保存自定义提示词模板
